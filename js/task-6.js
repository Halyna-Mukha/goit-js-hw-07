...
// Функція для створення колекції <div> елементів у DOM
function createBoxes(amount) {
  const boxesContainer = document.querySelector('#boxes');
  boxesContainer.innerHTML = ''; // Очищаємо вміст контейнера перед додаванням нових елементів
...
// Функція для очищення колекції <div> елементів у DOM
function destroyBoxes() {
  const boxesContainer = document.querySelector('#boxes');
  boxesContainer.innerHTML = ''; // Очищаємо вміст контейнера
}

// Отримуємо посилання на кнопки та input
